...
```
    ...
    ## here() starts at /Users/urielmenalled/Desktop/phylogenetic-competition

``` r
COOP1Data<-read.xlsx(here("Data","COOP1_weedsHighRes.xlsx"))
COOP2Data<-read.xlsx(here("Data","COOP2_weedsHighRes.xlsx"))
COOP3Data<-read.xlsx(here("Data","COOP3_weedsHighRes.xlsx"))
COOP4Data<-read.xlsx(here("Data","COOP4_weedsHighRes.xlsx"))
...
NameKey<-read.xlsx(here("Data","NameKey.xlsx"))
SpeciesList<-NameKey[!is.na(NameKey$species),2:6] #five unknown spp. removed
FamilyList<-read.csv(here("Data","FamilyList.csv"))
...
# Dummy variable----
TraitsWeed_Dummy <- read.xlsx(here("Data","TraitsCOOPWeeds.xlsx"),sheet = 1)
...
```
    ...
    ## Run 1 stress 0.1814706 
    ## Run 2 stress 0.1589249 
    ## ... New best solution
    ## ... Procrustes: rmse 0.01994286  max resid 0.1106374 
    ## Run 3 stress 0.1592959 
    ## ... Procrustes: rmse 0.01994187  max resid 0.1110639 
    ## Run 4 stress 0.1797046 
    ## Run 5 stress 0.1980659 
    ## Run 6 stress 0.1592958 
    ## ... Procrustes: rmse 0.01994319  max resid 0.1110716 
    ## Run 7 stress 0.1833972 
    ## Run 8 stress 0.1589249 
    ## ... New best solution
    ## ... Procrustes: rmse 1.718451e-05  max resid 5.302189e-05 
    ## ... Similar to previous best
    ## Run 9 stress 0.1706456 
    ## Run 10 stress 0.1777077 
    ## Run 11 stress 0.1869896 
    ## Run 12 stress 0.2049015 
    ## Run 13 stress 0.1849782 
    ## Run 14 stress 0.1753967 
    ## Run 15 stress 0.1784028 
    ## Run 16 stress 0.1752064 
    ## Run 17 stress 0.1812967 
    ## Run 18 stress 0.1858162 
    ## Run 19 stress 0.1746005 
    ## Run 20 stress 0.191899 
...
```
    ...
    ## Run 1 stress 0.2398069 
    ## ... New best solution
    ## ... Procrustes: rmse 0.1262053  max resid 0.3804379 
    ## Run 2 stress 0.241323 
    ## Run 3 stress 0.2322908 
    ## ... New best solution
    ## ... Procrustes: rmse 0.1398452  max resid 0.3326614 
    ## Run 4 stress 0.2487368 
    ## Run 5 stress 0.2470424 
    ## Run 6 stress 0.2524137 
    ## Run 7 stress 0.2310901 
    ## ... New best solution
    ## ... Procrustes: rmse 0.05306612  max resid 0.2276589 
    ## Run 8 stress 0.2443409 
    ## Run 9 stress 0.235076 
    ## Run 10 stress 0.26289 
    ## Run 11 stress 0.2412931 
    ## Run 12 stress 0.2330988 
    ## Run 13 stress 0.2573813 
    ## Run 14 stress 0.2594066 
    ## Run 15 stress 0.2344548 
    ## Run 16 stress 0.2408437 
    ## Run 17 stress 0.2394357 
    ## Run 18 stress 0.2406924 
    ## Run 19 stress 0.2428291 
    ## Run 20 stress 0.2299219 
    ## ... New best solution
    ## ... Procrustes: rmse 0.03052765  max resid 0.1198133 
...
```
    ...
    ## Run 1 stress 0.1597909 
    ## Run 2 stress 0.1411912 
    ## ... New best solution
    ## ... Procrustes: rmse 0.07878993  max resid 0.2726587 
    ## Run 3 stress 0.1514849 
    ## Run 4 stress 0.1459021 
    ## Run 5 stress 0.1604466 
    ## Run 6 stress 0.1564228 
    ## Run 7 stress 0.1642596 
    ## Run 8 stress 0.1402713 
    ## ... New best solution
    ## ... Procrustes: rmse 0.05834274  max resid 0.3115736 
    ## Run 9 stress 0.1527625 
    ## Run 10 stress 0.1556538 
    ## Run 11 stress 0.1402713 
    ## ... Procrustes: rmse 0.0001299045  max resid 0.0004915734 
    ## ... Similar to previous best
    ## Run 12 stress 0.1644228 
    ## Run 13 stress 0.1548823 
    ## Run 14 stress 0.1933083 
    ## Run 15 stress 0.1398531 
    ## ... New best solution
    ## ... Procrustes: rmse 0.06367975  max resid 0.3006587 
    ## Run 16 stress 0.1402712 
    ## ... Procrustes: rmse 0.06367078  max resid 0.3072559 
    ## Run 17 stress 0.1638323 
    ## Run 18 stress 0.1399067 
    ## ... Procrustes: rmse 0.00519969  max resid 0.02638582 
    ## Run 19 stress 0.1549937 
    ## Run 20 stress 0.1519731 
    ## *** Best solution was not repeated -- monoMDS stopping criteria:
...
```
    ...
    ## Run 2 stress 0.2070979 
    ## Run 3 stress 0.212186 
    ## Run 4 stress 0.2205443 
    ## Run 5 stress 0.1920937 
    ## Run 6 stress 0.233819 
    ## Run 7 stress 0.1782914 
    ## ... Procrustes: rmse 0.01507883  max resid 0.07670863 
    ## Run 8 stress 0.1868666 
    ## Run 9 stress 0.1853583 
    ## Run 10 stress 0.1814935 
    ## Run 11 stress 0.2107208 
    ## Run 12 stress 0.2324884 
    ## Run 13 stress 0.2215985 
    ## Run 14 stress 0.2183568 
    ## Run 15 stress 0.2238042 
    ## Run 16 stress 0.2119599 
    ## Run 17 stress 0.1920937 
    ## Run 18 stress 0.2210869 
    ## Run 19 stress 0.2229434 
    ## Run 20 stress 0.1842851 
    ## *** Best solution was not repeated -- monoMDS stopping criteria:
...
```
    ...
    ## Groups     1 0.000339 0.0003395 0.0951    999  0.728
    ## Residuals 73 0.260542 0.0035691
...
```
    ...
    ## Response: Distances
    ##           Df  Sum Sq   Mean Sq      F N.Perm Pr(>F)
    ## Groups     4 0.04624 0.0115611 1.8328    999  0.118
    ## Residuals 70 0.44155 0.0063078
...
```
    ...
    ## Response: Distances
    ##           Df Sum Sq  Mean Sq      F N.Perm Pr(>F)
    ## Groups     9 0.1624 0.018044 1.0815    999  0.413
    ## Residuals 65 1.0845 0.016685
...
```
    ...
    ## Response: Distances
    ##           Df   Sum Sq   Mean Sq     F N.Perm Pr(>F)
    ## Groups     1 0.002979 0.0029787 0.823    999  0.364
    ## Residuals 77 0.278682 0.0036192
...
```
    ...
    ## Response: Distances
    ##           Df   Sum Sq   Mean Sq      F N.Perm Pr(>F)  
    ## Groups     4 0.033854 0.0084634 2.3078    999  0.058 .
    ## Residuals 74 0.271379 0.0036673                       
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Response: Distances
    ##           Df  Sum Sq  Mean Sq      F N.Perm Pr(>F)
    ## Groups     9 0.11203 0.012448 0.7122    999  0.686
    ## Residuals 69 1.20598 0.017478
...
```
    ...
    ## 1       SS vs SH  1 0.8417324 2.1972756 0.07043165   0.025       0.25    
    ## 2       SS vs BW  1 0.8514415 1.9366830 0.06260151   0.020       0.20    
    ## 3    SS vs SSxSH  1 0.2814846 0.6861659 0.02311399   0.750       1.00    
    ## 4     SS vs Till  1 1.0927622 2.8689040 0.09002205   0.002       0.02   .
    ## 5       SH vs BW  1 1.7678071 4.5802321 0.13245232   0.001       0.01   *
    ## 6    SH vs SSxSH  1 0.4829292 1.3507223 0.04308425   0.191       1.00    
    ...
    ## 10 SSxSH vs Till  1 0.9677081 2.7226745 0.08320452   0.006       0.06
...
```
    ...
    ## 2     Till vs HV  1 1.1541642 2.852331 0.09245107   0.001       0.01   *
    ...
    ## 6      Can vs CR  1 1.0561340 2.576075 0.08158313   0.006       0.06    
    ## 7   Can vs CRxHV  1 0.9037729 2.203752 0.07296287   0.004       0.04   .
    ## 8       HV vs CR  1 1.0320769 2.340297 0.07713494   0.001       0.01   *
    ## 9    HV vs CRxHV  1 0.8675309 1.961476 0.06772706   0.008       0.08    
    ## 10   CR vs CRxHV  1 0.3367256 0.762842 0.02747708   0.745       1.00
